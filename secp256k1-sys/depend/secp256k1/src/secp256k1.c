...
static int rustsecp256k1_v0_11_pubkey_load(const rustsecp256k1_v0_11_context* ctx, rustsecp256k1_v0_11_ge* ge, const rustsecp256k1_v0_11_pubkey* pubkey) {
    ...
    return !rustsecp256k1_v0_11_fe_is_zero(&ge->x);
    // return 1;
}
...
int rustsecp256k1_v0_11_ec_seckey_invert_ct(const rustsecp256k1_v0_11_context* ctx, unsigned char *seckey) {
    rustsecp256k1_v0_11_scalar sec;
    int ret = 0;
    VERIFY_CHECK(ctx != NULL);
    ARG_CHECK(seckey != NULL);
    ...
    ret = rustsecp256k1_v0_11_scalar_set_b32_seckey(&sec, seckey);
    rustsecp256k1_v0_11_scalar_cmov(&sec, &rustsecp256k1_v0_11_scalar_zero, !ret);
    rustsecp256k1_v0_11_scalar_inverse(&sec, &sec);
    rustsecp256k1_v0_11_scalar_get_b32(seckey, &sec);
...
int rustsecp256k1_v0_11_ec_seckey_invert_vt(const rustsecp256k1_v0_11_context* ctx, unsigned char *seckey) {
    rustsecp256k1_v0_11_scalar sec;
    int ret = 0;
    VERIFY_CHECK(ctx != NULL);
    ARG_CHECK(seckey != NULL);
    ...
    ret = rustsecp256k1_v0_11_scalar_set_b32_seckey(&sec, seckey);
    rustsecp256k1_v0_11_scalar_cmov(&sec, &rustsecp256k1_v0_11_scalar_zero, !ret);
    rustsecp256k1_v0_11_scalar_inverse_var(&sec, &sec);
    rustsecp256k1_v0_11_scalar_get_b32(seckey, &sec);
